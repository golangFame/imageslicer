...
Peform advanced image processing in Go - slice images into tiles, combine the tile.
...
### Usecase 1: Split Images into Tiles on the basis of a Grid[m,n]
...
- Ensure that the grid dimensions specified were the same as original while uploading.
