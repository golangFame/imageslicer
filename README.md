...
[![Go 1.19+](https://github.com/golangFame/imageslicer/actions/workflows/go.yml/badge.svg?branch=main)](https://github.com/golangFame/imageslicer/actions/workflows/go.yml?branch=main)
[![Ubuntu,Mac,Win Go1.19+](https://github.com/golangFame/imageslicer/actions/workflows/go_cross.yml/badge.svg?branch=main)](https://github.com/golangFame/imageslicer/actions/workflows/go_cross.yml?branch=main)
[![Rigorous Tests](https://github.com/golangFame/imageslicer/actions/workflows/go_test.yml/badge.svg?branch=main)](https://github.com/golangFame/imageslicer/actions/workflows/go_test.yml?branch=main)
[![Go Fuzz](https://github.com/golangFame/imageslicer/actions/workflows/go_fuzz.yml/badge.svg?branch=main)](https://github.com/golangFame/imageslicer/actions/workflows/go_fuzz.yml?branch=main)
[![Go.Dev](https://img.shields.io/badge/go.dev-reference-007d9c?logo=go&logoColor=white)](https://pkg.go.dev/github.com/golangFame/imageslicer?tab=doc)
...
This incident made me realize that I can build a 35x faster library in Go. Hence, the inception of [image-slicer](https://github.com/golangFame/imageslicer).
...
You can file an [Issue](https://github.com/golangFame/imageslicer/issues/new).
See documentation in [Go.Dev](https://pkg.go.dev/github.com/golangFame/imageslicer?tab=doc)
...
```
[Inspired from ...](https://github.com/golangFame/imageslicer/blob/main/imageslicer_test.go#L123)
...
- ```Join(tiles,grid) (img image.Image, err error)```
    ...
    - For best results, ensure the tiles were generated by [image-slicer](https://github.com/golangFame/imageslicer).
